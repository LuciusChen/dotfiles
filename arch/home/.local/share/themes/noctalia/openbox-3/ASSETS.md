# Labwc titlebar button assets

The SVG titlebar buttons installed alongside the generated `themerc` are from
the Adwaita-dark variant of `davidphilipbarr/labwc-adwaita`:
