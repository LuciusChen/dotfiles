...
(defvar gotham-color-alist
  `((base0   "#1d1d20" ,(if gotham-tty-256-colors "color-232" "black"))
    (base1   "#263d3e" ,(if gotham-tty-256-colors "color-233" "brightblack"))
    (base2   "#2f5e5c" ,(if gotham-tty-256-colors "color-17"  "brightgreen"))
    (base3   "#387e7a" ,(if gotham-tty-256-colors "color-18"  "brightblue"))
    (base4   "#419e97" ,(if gotham-tty-256-colors "color-24"  "brightyellow"))
    (base5   "#4abeb5" ,(if gotham-tty-256-colors "color-81"  "brightcyan"))
    (base6   "#53dfd3" ,(if gotham-tty-256-colors "color-122" "white"))
    (base7   "#5cfff1" ,(if gotham-tty-256-colors "color-194" "brightwhite"))
...
(gotham-set-faces
 '((default :foreground base6 :background base0)
   ...
   ;; org-mode
   (org-level-1 :bold t :foreground "#08e717" :height 1.1)
   (org-level-2 :bold nil :foreground "#ff7033")
   (org-level-3 :bold t :foreground "#bf57e5")
   (org-level-4 :bold nil :foreground "#57f4ff")
   ...
   (org-scheduled :foreground "#14ff24")
